...
export default function BrewDetail() {
  ...
  const radarData = [
    ...
    ...((brew.flavorProfile as any).texture > 1 ? [{ attr: 'Texture', value: (brew.flavorProfile as any).texture }] : []),
    ...((brew.flavorProfile as any).fruit > 1 ? [{ attr: 'Fruit', value: (brew.flavorProfile as any).fruit }] : []),
    ...((brew.flavorProfile as any).chocolateCaramel > 1 ? [{ attr: 'Choc/Caramel', value: (brew.flavorProfile as any).chocolateCaramel }] : []),
